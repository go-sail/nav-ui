    ...
    <div class="lock-box">
      ...
      <form @submit.prevent="handleUnlock">
        <div class="form-group">
          <label for="unlock-password">请输入用户名:</label>
          <input
            id="unlock-password"
            type="text"
            v-model="username"
        ...
        <div class="form-group">
          <label for="unlock-password">请输入密码:</label>
          <input
            id="unlock-password"
            type="password"
            v-model="password"
  ...
  <div v-else class="nav-home">
    ...
    <aside class="sidebar">
      ...
      <div class="logo-section">
        ...
        <h1 class="site-title">{{ title || 'Go-Sail导航站' }}</h1>
      </div>
      ...
      <nav class="category-nav">
        <h2 class="nav-title">分类导航</h2>
          ...
          <li
            ...
            class="category-item"
            @click="scrollToCategory(category.identity)"
          >
            <span class="category-icon">
              <img :src="category.icon" :alt="category.name" style="width: 30px; height: 30px;" />
            </span>
            <span class="category-name" style="padding-left: 8px;">{{ category.name }}</span>
          </li>
        </ul>
      </nav>
      ...
      <div class="sidebar-footer">
        <a
          href="https://github.com/go-sail/nav-ui"
          target="_blank"
        ...
        <div class="mobile-menu" :class="{ active: showMobileMenu }">
          <div class="mobile-menu-header">
            ...
            <li
              ...
              @click="scrollToCategoryMobile(category.identity)"
            >
              <span class="category-icon">
                <img :src="category.icon" :alt="category.name" style="width: 30px; height: 30px;" />
              </span>
        ...
        <div v-else class="categories-container">
          ...
          >
            ...
            <div class="sites-grid">
              ...
              >
                <div class="site-icon">
                  <img :src="site.icon" :alt="site.name" @error="handleImageError" style="width: 30px; height: 30px;" />
                </div>
                <div class="site-info">
          ...
          <footer class="page-footer" hidden="true">
            ...
            <div class="footer-bottom">
              <p>&copy; {{ new Date().getFullYear() }} Go-Sail导航站 - 由 <a href="https://github.com/maodeyu180" target="_blank" rel="noopener noreferrer">maodeyu180</a> 用 ❤️ 制作</p>
...
// 打开GitHub项目页面
const openGitHub = () => {
  window.open('https://github.com/go-sail/nav-ui', '_blank')
}
